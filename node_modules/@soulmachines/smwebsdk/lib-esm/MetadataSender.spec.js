...
describe('MetadataSender', function () {
    ...
    beforeEach(function () {
        ...
        metadataSender = new MetadataSender(mockScene);
    });
    ...
    describe('observeUrlChanges', function () {
        ...
        it('sends a PAGE_METADATA message when the url changes', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
        ...
        it('does not call sendRequest when the url does not change', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
