...
exports.ContentAwareness = void 0;
var resize_observer_1 = require("@juggle/resize-observer");
var allImagesLoaded_1 = require("./utils/allImagesLoaded");
...
var ContentAwareness = /** @class */ (function () {
    function ContentAwareness(scene, debounceTime, logger) {
        ...
        this.debouncedMeasure = (0, debounce_1.debouncedFunction)(function () { return _this.measureInternal(); }, debounceTime);
        this.resizeObserver = new resize_observer_1.ResizeObserver(function () { return _this.measureDebounced(); });
    ...
    ContentAwareness.prototype.mutationCallback = function (mutations) {
        ...
        if (this.callMeasure) {
            if (imagesAdded) {
                ...
                (0, allImagesLoaded_1.default)().then(function () {
...
exports.ContentAwareness = ContentAwareness;
