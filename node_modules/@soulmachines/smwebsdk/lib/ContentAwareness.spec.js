...
describe('ContentAwareness', function () {
    ...
    var mockVideoBoundingClientRect = tslib_1.__assign(tslib_1.__assign({}, mockContentBoundingClientRect), { left: 500, right: 600, top: 700, bottom: 800 });
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    mockScene = new Scene_1.Scene(undefined);
                    mockScene.isConnected = jest.fn(function () { return true; });
                    videoElement = createSmVideoElement('originalVideo');
                    document.body.append(videoElement);
                    ca = new ContentAwareness_1.ContentAwareness(mockScene, undefined, mockLogger);
    ...
    it('calls observe on the mutation observer with the correct option', function () {
        ...
        ca = new ContentAwareness_1.ContentAwareness(mockScene);
    ...
    it('sets the debounce time to the passed in value', function () {
        ca = new ContentAwareness_1.ContentAwareness(mockScene, 9999);
    ...
    describe('measure', function () {
        describe('when content is present', function () {
            it('does not call the log method', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            jest.clearAllMocks();
        ...
        it('logs a scene not connected error when the scene is not connected', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('logs a unable to find the video warning when the video frame is not present', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a;
        ...
        it('logs a warning and does not send an updateContentAwareness message when the video frame dimensions are invalid', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var videoEl;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        jest.clearAllMocks();
                        jest.spyOn(videoEl, 'getBoundingClientRect').mockReturnValue(tslib_1.__assign(tslib_1.__assign({}, mockContentBoundingClientRect), { width: 0, height: 0 }));
                        return [4 /*yield*/, waitForNextTick()];
                    case 1:
                        _a.sent();
                        ca.measure();
    ...
    describe('measureContent', function () {
         ...
         */
        it('does not send duplicate content element IDs', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        it('should log a warning if the sm-content width and height are <= zero and add it to the content collection', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var id, el;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        el.setAttribute('data-sm-content', id);
                        jest.spyOn(el, 'getBoundingClientRect').mockReturnValue(tslib_1.__assign(tslib_1.__assign({}, mockContentBoundingClientRect), { width: 0, height: 0 }));
        ...
        it('should log a warning if the sm-content has no coordinates and not add it to the content collection', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var id, el;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        el.setAttribute('data-sm-content', id);
                        document.body.append(el);
                        jest.spyOn(el, 'getBoundingClientRect').mockReturnValue(tslib_1.__assign(tslib_1.__assign({}, mockContentBoundingClientRect), { top: 0, left: 0, right: 0, bottom: 0 }));
                        return [4 /*yield*/, waitForNextTick()];
                    case 1:
                        _a.sent();
                        jest.runAllTimers();
        ...
        it('should log a warning if the sm-video width and height are <= zero', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var id, el;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
