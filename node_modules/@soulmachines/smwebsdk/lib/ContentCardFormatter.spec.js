...
describe('ContentCardFormatter', function () {
    ...
    beforeEach(function () {
        contentCardFormatter = new ContentCardFormatter_1.ContentCardFormatter();
    });
    describe('format', function () {
        describe('when the body is a legacy dialogflow object', function () {
            it('returns the formatted cards with an id and data key', function () {
                expect(contentCardFormatter === null || contentCardFormatter === void 0 ? void 0 : contentCardFormatter.format(conversationResultMessage_1.legacyDialogflowMessage.body)).toEqual([
                    {
                        data: {
                            id: 'image',
                            position: 'right',
        ...
        describe('when the body is a dialogflow object', function () {
            it('returns the formatted cards with an id and data key', function () {
                expect(contentCardFormatter === null || contentCardFormatter === void 0 ? void 0 : contentCardFormatter.format(conversationResultMessage_1.dialogflowMessage.body)).toEqual([
                    {
                        data: {
                            id: 'cat',
                            type: 'image',
        ...
        describe('when the body is a watson object', function () {
            it('returns the formatted cards with an id and data key', function () {
                ...
                expect(contentCardFormatter === null || contentCardFormatter === void 0 ? void 0 : contentCardFormatter.format(conversationResultMessage_1.watsonMessage.body)).toEqual([
                    {
                        data: {
                            id: 'options',
                            type: 'options',
