...
var conversationResultMessage_1 = require("./utils/test-utils/conversationResultMessage");
...
describe('conversation', function () {
    var conversation;
    var mockLogger = new Logger_1.Logger();
    var mockConversationState = new ConversationState_1.ConversationState();
    var mockContentCardFormatter = new ContentCardFormatter_1.ContentCardFormatter();
    ...
    beforeEach(function () {
        ...
        conversation = new Conversation_1.Conversation(mockLogger, mockConversationState, mockContentCardFormatter);
    ...
    it('adds the active card when speechMarker name is showcards', function () {
        conversation.onSpeechMarker(speechMarkerResult_1.showcardsMessage.body);
    ...
    it('calls onCardChanged with an empty array when card is removed with hidecards', function () {
        ...
        conversation.onSpeechMarker(speechMarkerResult_1.hidecardsMessage.body);
    ...
    it('clears all active card ids when hide all cards is shown', function () {
        ...
        conversation.onSpeechMarker(speechMarkerResult_1.hideallcardsMessage.body);
        expect(conversation.activeCardIds.size).toEqual(0);
    });
    ...
    describe('onConversationResult', function () {
        ...
        describe('automatically clearing content cards', function () {
            ...
            it('calls onCardChanged with an empty array', function () {
                conversation.onConversationResult(conversationResultMessage_1.dialogflowMessage.body);
                expect(mockSMEvent.call).toHaveBeenCalledWith([]);
            });
